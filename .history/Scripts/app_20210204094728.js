    ...
    function displayContactList() 
    {
      if (localStorage.length > 0) 
      {
        ...
        for (let index = 0; index < localStorage.length; index++) 
        {
          ...
          <td class="text-center"><button data= "${index + 1}" class="btn btn-primary btn-sm"><i class="fas fa-edit fa-sm"></i>Edit</button></td>
          <td class= "text-center"><button data= "${index + 1}" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt fa-sm"></i>Delete</button></td>
        </tr>`;
        }
