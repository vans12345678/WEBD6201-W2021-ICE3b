    ...
    function displayContactList() 
    {
      if (localStorage.length > 0) 
      {
        ...
        for (let index = 0; index < localStorage.length; index++) 
        {
          ...
          <td><button class="text-center btn btn-primary btn-sm"><i class="fas fa-edit fa-sm"></i>Edit</button></td>
          <td><button class="text-center btn btn-danger btn-sm"><i class="fas fa-trash-alt fa-sm"></i>Delete</button></td>
        </tr>`;
        }
